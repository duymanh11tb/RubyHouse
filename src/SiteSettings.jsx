...
export default function SiteSettings({settings={}}){
  useEffect(()=>{
    ...
    text('.hero-description',settings.hero_description);text('.hero-caption .eyebrow','Your trusted home away from home');text('.hero-caption h3',settings.hero_caption);text('.about-kicker h2',settings.about_title);
